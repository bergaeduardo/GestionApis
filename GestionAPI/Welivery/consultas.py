...
# Consulta para obtener pedidos pendientes de impresión de etiquetas
...
AND METODO_ENVIO = 'FLEX'
AND NUM_SEGUIMIENTO IS NOT NULL
AND (IMP_ROT IS NULL OR IMP_ROT = 0)
ORDER BY NRO_PEDIDO DESC
"""

# Actualizar campo IMP_ROT para marcar etiquetas impresas
QRY_UPDATE_IMP_ROT = """
UPDATE SEIN_TABLA_TEMPORAL_SCRIPT 
SET IMP_ROT = 1
WHERE NRO_PEDIDO = ? AND TALON_PED = CAST(? AS INT)
